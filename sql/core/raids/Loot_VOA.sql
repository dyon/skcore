...
(@NPC, 49426, 100, 1, 0, 2, 2), -- Emblem of frost
(@NPC, 1, 100, 1, 0, -@TORAVON25, 3), -- Gear(Wrathful PVP, T10.5 PVE)
(@NPC, 2, 1, 1, 0, -34203, 1); -- Mount
-- Update loot template for Toravon 10
SET @NPC =38433;
DELETE FROM `creature_loot_template` WHERE `entry`=@NPC;
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
(@NPC, 47241, 100, 1, 0, 2, 2), -- Emblem of triumph
(@NPC, 1, 100, 1, 0, -@TORAVON10, 2), -- Gear(Relentless PVP, T10 PVE)
(@NPC, 2, 1, 1, 0, -34203, 1); -- Mount
...
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
(@NPC, 47241, 100, 1, 0, 2, 2), -- Emblem of triumph
(@NPC, 1, 100, 1, 0, -@ARCHAVON10, 2), -- Gear(Hate PVP, T7 PVE)
(@NPC, 2, 1, 1, 0, -34203, 1); -- Mount
...
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
(@NPC, 47241, 100, 1, 0, 2, 2), -- Emblem of triumph
(@NPC, 1, 100, 1, 0, -@ARCHAVON25, 4), -- Gear(Deadly PVP, T7(25) PVE)
(@NPC, 2, 1, 1, 0, -34203, 1); -- Mount
...
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
(@NPC, 47241, 100, 1, 0, 2, 2), -- Emblem of triumph
(@NPC, 1, 100, 1, 0, -@EMALON10, 2), -- Gear(Deadly PVP, T8 PVE)
(@NPC, 2, 1, 1, 0, -34203, 1); -- Mount
...
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
(@NPC, 47241, 100, 1, 0, 2, 2), -- Emblem of triumph
(@NPC, 1, 100, 1, 0, -@EMALON25, 4), -- Gear(Deadly PVP, T8(25) PVE)
(@NPC, 2, 1, 1, 0, -34203, 1); -- Mount
...
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
(@NPC, 47241, 100, 1, 0, 2, 2), -- Emblem of triumph
(@NPC, 1, 100, 1, 0, -@KORALON10, 2), -- Gear(Furious PVP, T9 PVE)
(@NPC, 2, 1, 1, 0, -34203, 1); -- Mount
...
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `lootmode`, `groupid`, `mincountOrRef`, `maxcount`) VALUES
(@NPC, 47241, 100, 1, 0, 2, 2), -- Emblem of triumph
(@NPC, 1, 100, 1, 0, -@KORALON25, 4), -- Gear(Relentless PVP, T9.5 PVE)
(@NPC, 2, 1, 1, 0, -34203, 1); -- Mount