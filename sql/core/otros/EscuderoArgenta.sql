-- Gossip flag
UPDATE creature_template SET npcflag = npcflag | 0x81, gossip_menu_id = 50120, `ScriptName` = 'npc_argent_squire' WHERE `entry` = 33238;
UPDATE creature_template SET npcflag = npcflag | 0x81, gossip_menu_id = 50121, `ScriptName` = 'npc_argent_squire' WHERE `entry` = 33239;
DELETE FROM gossip_menu WHERE entry IN (50120, 50121);
