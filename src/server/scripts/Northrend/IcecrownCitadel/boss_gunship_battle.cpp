    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* pCreature)
        {
            ...
            if (pInstance && pInstance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
            {
                ...
                player->ADD_GOSSIP_ITEM(0, "Mis compañeros están listos, Muradin. ¡Vamos allá!", 631, 1001);
        ...
        bool OnGossipSelect(Player* player, Creature* pCreature, uint32 /*sender*/, uint32 action)
        {
            ...
            if (action == GOSSIP_ACTION_INFO_DEF+2)
                pCreature->MonsterSay("Esperaré al lider de la banda.", LANG_UNIVERSAL, player->GetGUID());
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* pCreature)
        {
            ...
            if (pInstance && pInstance->GetData(DATA_TEAM_IN_INSTANCE) == HORDE)
            {
                ...
                player->ADD_GOSSIP_ITEM(0, "Mis compañeros están listos, Saurfang. ¡Vamos allá!", 631, 1001);
                player->SEND_GOSSIP_MENU(player->GetGossipTextId(pCreature), pCreature->GetGUID());
                return true;
            }
            return false;
